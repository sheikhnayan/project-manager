...
<div class="content grid grid-cols-5 gap-4" style="grid-auto-rows: 1fr;">
    <div style="">
    ...
    <div class="col-span-2">
        <div style="border: 1px solid #D1D5DB; margin: 16px; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.15); padding-top: 0px; border-radius: 8px; margin-right: 16px; padding: 12px; padding-bottom: 20px; height: auto;">

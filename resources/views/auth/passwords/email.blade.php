            ...
            <div class="relative z-10 text-white px-12 slide-in">
                <div class="mb-8">
                    <div class="w-16 h-16 bg-white rounded-lg flex items-center justify-center mb-6">
                        <i data-lucide="key" class="w-10 h-10 text-gray-900"></i>
                    </div>
                    <h1 class="text-5xl font-bold mb-4">Reset your password</h1>
                    <p class="text-xl text-gray-300">We'll send you a secure link to reset your password.</p>
                </div>
                ...
                <div class="space-y-4 mt-12">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-lg">Secure password reset process</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                            <i data-lucide="check" class="w-5 h-5"></i>
                        </div>
                        <span class="text-lg">Link expires in 60 minutes</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                            <i data-lucide="check" class="w-5 h-5"></i>
                        </div>
                        <span class="text-lg">Back to work in no time</span>
                    </div>
                </div>
            </div>
        </div>

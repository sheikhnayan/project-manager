            ...
            <div class="relative z-10 text-white px-12 slide-in">
                <div class="mb-8">
                    <div class="w-16 h-16 bg-white rounded-lg flex items-center justify-center mb-6">
                        <i data-lucide="shield-check" class="w-10 h-10 text-gray-900"></i>
                    </div>
                    <h1 class="text-5xl font-bold mb-4">Create your new password</h1>
                    <p class="text-xl text-gray-300">Choose a strong password to keep your account secure.</p>
                </div>
                ...
                <div class="space-y-4 mt-12">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-lg">Use a unique password</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center">
                            <i data-lucide="check" class="w-5 h-5"></i>
                        </div>
                        <span class="text-lg">Keep it safe and secure</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md fade-in">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-gray-900 hover:text-gray-700 inline-flex items-center">
